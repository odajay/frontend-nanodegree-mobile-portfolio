...
var resizePizzas = function(size) {
    ...
    // Jon comments for Reviewer: Optimization using getElementById
    ...
    // Jon comments for Reviewer: Simplification based on the FSL jank class. Getting rid of the previous dx function which was doing unncessary work. Additionaly, optimization using getElementsByClassName and getElementById
...
//Jon comments for Reviewer: Implementing ticking optimization
var ticking = false;
...
function updatePositions() {
    ...
    //Jon comments for Reviewer: as some value don't change during the loop, I am taking them off it then store them in a variable.
    ...
    for (var i = 0; i < itemsLength; i++) {
        // Jon comments for Reviewer: Using transform  in order reduce the loading time
        items[i].style.transform = "translateX(" + phases[j] + "px)";
        j++;
        //Jon comments for Reviewer: Be sure that j won't go over 4
        j = (j > 4) ? 0 : j;
    }
    ...
    //Jon comments for Reviewer: put status false to the ticking at the end of the function for the rAF purpose
    ticking = false;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    for (var i = 0; i < 48; i++) {
        ...
        //Jon comments for Reviewer: Fixing the original pizza location due to the transform
        elem.style.left = (i % cols) * s + "px";
        elem.style.top = (Math.floor(i / cols) * s) + 'px';
        document.getElementById("movingPizzas1").appendChild(elem);
        //Jon comments for Reviewer: attribute to a variable the css element for the moving pizza on DOM Load
